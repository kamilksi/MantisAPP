...
import '../domain/use_cases/get_posts_use_case.dart' as _i9;
import '../presentation/pages/blog/cubit/blog_cubit.dart' as _i11;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i9.GetPostsUseCase>(
      () => _i9.GetPostsUseCase(get<_i5.MantisRepository>()));
  gh.factory<_i10.HomeCubit>(() => _i10.HomeCubit(get<_i8.GetMantisUseCase>()));
  gh.factory<_i11.BlogCubit>(() => _i11.BlogCubit(get<_i9.GetPostsUseCase>()));
  return get;
}

class _$DioModule extends _i12.DioModule {}

class _$MantisDataSourceModule extends _i13.MantisDataSourceModule {}
